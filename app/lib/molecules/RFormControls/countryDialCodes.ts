// Country dialling codes for the phone control's searchable combobox.
//
// Flags are not stored — they are rendered from the ISO-3166-1 alpha-2 code via
// the `flag-icons` SVG set (`fi fi-<iso2>`), keeping this list compact. SVG flags
// render consistently everywhere, unlike flag emoji (absent on iOS Simulator /
// Windows).

export type PhoneCountry = {
  /** Display name, searchable. */
  name: string;
  /** ISO-3166-1 alpha-2 code — drives the flag (and the Monday country field). */
  iso2: string;
